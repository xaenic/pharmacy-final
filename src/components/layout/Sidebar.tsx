...
const Sidebar = () => {
  ...
  return (
    <aside
      id="sidebar"
      className={`z-40 bg-white shadow-sm border  xl:left-0 pb-36 duration-300 transition-all  w-48  p-5 rounded-xl mt-5 ml-3 h-[95%] lg:m-4  fixed top-0  bottom-0   flex-col justify-between ${
